...
//		points[23] = new Point('O', 2);
		...
		points[0] = new Point('X', 2);
		points[1] = new Point('X', 2);
		points[2] = new Point('X', 2);
		points[3] = new Point('X', 2);
		points[4] = new Point('X', 2);
		...
		points[17] = new Point('-', 0);
		points[18] = new Point('X', 5);
		points[19] = new Point('X', 2);
		points[20] = new Point('X', 2);
		points[21] = new Point('X', 2);
		points[22] = new Point('X', 2);
		points[23] = new Point('X', 2);
